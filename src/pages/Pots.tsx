              ...
              <div className="flex justify-between items-center relative w-full">
                  ...
                  </button>
                  {
                    ...
                    <div className="absolute z-2 top-50 left-8 lg:top-100 lg:left-100 bottom-0">
                      <NewPot isOpen={isOpen} setIsOpen={setIsOpen} onSubmit={(newPot) => setPotsCard([...potsCard, newPot])} />
                    </div>}
              </div>
                    ...
                    {potsCard.map((pot, index) => {
                      return (
                        ...
                        >
                          ...
                          <p className="text-xl font-semibold">{Number(pot.amount).toLocaleString()}</p>
